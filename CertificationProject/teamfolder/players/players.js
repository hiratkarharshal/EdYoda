        ...
        if(playersDetails.length > 0){
            ...
            playersDetails.forEach((eachPlayer) => {
                if(eachPlayer.id == playerID){
                    playerHTML += `<tr>
                    <td rowspan="6" style="text-align:center;background-color: azure;"><img class="player-logo" src="${eachPlayer.profileIcon}" alt="${eachPlayer.playerName}"/></td>
                </tr>
                        <tr>
                    <th>Full Name</th>
            ...
            $("#player-details-cstm table tbody").append(playerHTML);
        }
    }
});