...
for (let i = 0; i < productData.photos.length; i++) {
    ...
    getImageHTML += `<img class="thumbail ${className}" id="img-${productData.id+i}" src="${productData.photos[i]}" alt="Image Preview - ${i}">`;
}
let createProductHTML = `<h1 id="name">${productData.name}</h1>
