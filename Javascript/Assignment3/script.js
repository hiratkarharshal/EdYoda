...
var productList = [
    ...
    function carding(i) {
        ...
        card.classList.add('clothing-cards');
        // Image Container
        var imageContainer = document.createElement('div');
        imageContainer.classList.add('image-container');
        // Image
        var mainImage = document.createElement('img');
        mainImage.src = productList[i].preview;
        ...
        brandName.innerText = productList[i].brand;
        // Product Price
        var Cardprice = document.createElement('p');
        Cardprice.classList.add('product-price');
        Cardprice.innerText = "Rs" + " " + productList[i].price;
    
    
        // Appending Section
        contentContainer.appendChild(productName);
        contentContainer.appendChild(brandName);
